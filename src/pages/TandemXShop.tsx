        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="bg-muted/20 rounded-lg p-6 mt-10">
              ...
              <p className="mb-4">
                This page demonstrates how Sparkyardy can integrate with external shops like TandemX.
                Artists and creators can connect their existing shops to their Sparkyardy profile.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="space-y-2">
                  <h3 className="font-semibold">Benefits for Shop Owners:</h3>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Showcase your existing shop to the Sparkyardy community</li>
