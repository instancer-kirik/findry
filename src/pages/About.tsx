      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <section className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">About Sparkyardy</h1>
          ...
          <Card className="mb-12">
            <CardHeader>
              ...
              <CardDescription>Why we built Sparkyardy</CardDescription>
            </CardHeader>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    With a background in both art and technology, he founded Sparkyardy to bridge the gap
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    ...
                    ensuring that Sparkyardy remains intuitive and responsive.
                  </p>
                  <div className="flex mt-4 gap-2">
                    <Button variant="outline" size="icon">
                      <Github className="h-4 w-4" />
          ...
          <Card className="mb-12 bg-primary/5 border-primary/20">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Sparkyardy is in active development. Check out our roadmap to see completed features, 
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="flex flex-col h-full">
                ...
                <CardContent className="flex-1">
                  <p className="text-muted-foreground mb-6">
                    Have questions, feedback, or ideas for improving Sparkyardy? We'd love to hear from you.
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold mb-2">What is Sparkyardy?</h3>
                <p className="text-muted-foreground">
                  Sparkyardy means to gather, rally, and assemble — exactly what we do for creative communities.
                </p>
              </div>
              ...
              <Separator className="my-4" />
              <div>
                <h3 className="text-lg font-semibold mb-2">Is Sparkyardy available in my area?</h3>
                <p className="text-muted-foreground">
                  Sparkyardy is currently focused on building strong communities in select regions, with plans to expand. 
              ...
              <Separator className="my-4" />
              <div>
                <h3 className="text-lg font-semibold mb-2">How can I contribute to Sparkyardy's development?</h3>
                <p className="text-muted-foreground">
